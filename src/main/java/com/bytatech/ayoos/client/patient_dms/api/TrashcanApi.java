...
import com.bytatech.ayoos.client.patient_dms.model.DeletedNodeBodyRestore;
import com.bytatech.ayoos.client.patient_dms.model.DeletedNodeEntry;
import com.bytatech.ayoos.client.patient_dms.model.DeletedNodesPaging;
...
public interface TrashcanApi {
    ...
    @ApiOperation(value = "Get rendition content of a deleted node", nickname = "getArchivedNodeRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for **renditionId** of file **nodeId**. ", response = Resource.class, tags={ "trashcan", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get deleted node content", nickname = "getDeletedNodeContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the content of the deleted node with identifier **nodeId**. ", response = Resource.class, tags={ "trashcan", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = Resource.class),
        @ApiResponse(code = 206, message = "Partial Content"),
        @ApiResponse(code = 304, message = "Content has not been modified since the date provided in the If-Modified-Since header"),
