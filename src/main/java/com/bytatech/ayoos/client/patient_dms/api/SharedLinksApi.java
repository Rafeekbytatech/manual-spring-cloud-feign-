...
import com.bytatech.ayoos.client.patient_dms.model.SharedLinkBodyCreate;
import com.bytatech.ayoos.client.patient_dms.model.SharedLinkBodyEmail;
import com.bytatech.ayoos.client.patient_dms.model.SharedLinkEntry;
import com.bytatech.ayoos.client.patient_dms.model.SharedLinkPaging;
...
public interface SharedLinksApi {
    ...
    @ApiOperation(value = "Get shared link content", nickname = "getSharedLinkContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the content of the file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", response = Resource.class, tags={ "shared-links", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get shared link rendition content", nickname = "getSharedLinkRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", response = Resource.class, tags={ "shared-links", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = Resource.class),
        @ApiResponse(code = 206, message = "Partial Content"),
        @ApiResponse(code = 304, message = "Content has not been modified since the date provided in the If-Modified-Since header"),
