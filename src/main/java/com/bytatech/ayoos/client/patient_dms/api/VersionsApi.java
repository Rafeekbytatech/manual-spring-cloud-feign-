...
import com.bytatech.ayoos.client.patient_dms.model.RevertBody;
import com.bytatech.ayoos.client.patient_dms.model.VersionEntry;
import com.bytatech.ayoos.client.patient_dms.model.VersionPaging;
...
public interface VersionsApi {
    ...
    @ApiOperation(value = "Get version content", nickname = "getVersionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the version content for **versionId** of file node **nodeId**. ", response = Resource.class, tags={ "versions", })
    @ApiResponses(value = { 
